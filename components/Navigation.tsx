...
export const Navigation: React.FC<NavigationProps> = ({ activePage, onNavigate, onOpenInquiry }) => {
  ...
  return (
    <nav
      ...
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 border-b ${mobileMenuOpen
        ...
        <div className="hidden lg:flex items-center justify-center absolute left-1/2 -translate-x-1/2">
          <div className="flex items-center gap-1 p-1.5 rounded-full bg-surface/50 border border-border backdrop-blur-md shadow-sm">
            ...
            >
              ...
              {/* Mega Menu Dropdown */}
              <div
                className={`absolute top-full left-1/2 -translate-x-1/2 pt-6 w-[600px] transition-all duration-300 transform origin-top ${hoveredNav === 'services'
          ...
          <div className={`mt-auto pt-12 transition-all duration-500 delay-500 shrink-0 ${mobileMenuOpen ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end border-t border-border pt-8 gap-6">
              ...
              <div className="flex gap-4">
                <a href="https://x.com/AyebaDevs" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-surface border border-border text-secondary hover:text-primary hover:border-accent transition-all hover:scale-110" aria-label="X (Twitter)">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                </a>
                <a href="https://github.com/Ayeba12" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-surface border border-border text-secondary hover:text-primary hover:border-accent transition-all hover:scale-110" aria-label="GitHub"><Github size={20} /></a>
                <a href="https://www.linkedin.com/in/sam-ayebanate/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-surface border border-border text-secondary hover:text-primary hover:border-accent transition-all hover:scale-110" aria-label="LinkedIn"><Linkedin size={20} /></a>
              </div>
            </div>
          </div>
        </div>
