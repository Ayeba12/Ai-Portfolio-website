              ...
              <div className="flex flex-wrap gap-3">
                {PROJECT_TYPES.map(type => (
                  <button
                    ...
                    className={`px-6 py-3 rounded-full border transition-all duration-300 ${formData.projectType.includes(type)
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {BUDGET_RANGES.map(range => (
                <button
                  ...
                  className={`p-6 text-left rounded-xl border transition-all duration-300 flex items-center justify-between group ${formData.budget === range
